...
import bridge.pluginmodule.config.ConfigAccessorImpl;
...
public interface ConfigAccessor {
     ...
     */
    @Contract("_ -> new")
    static @NotNull ConfigAccessor create(final File configurationFile) throws InvalidConfigurationException, FileNotFoundException {
     ...
     */
    @Contract("_, _ -> new")
    static @NotNull ConfigAccessor create(final Plugin plugin, final String resourceFile) throws InvalidConfigurationException, FileNotFoundException {
     ...
     */
    @Contract("_, _, _ -> new")
    static @NotNull ConfigAccessor create(final File configurationFile, final Plugin plugin, final String resourceFile) throws InvalidConfigurationException, FileNotFoundException {
