...
public class StartScreen {
    ...
    public void BridgeImage() {
        log(n
                ...
                .append(Component.text("  odk0K0kdoON                  NOodk0K0kdo   ").color(TextColor.fromHexString("#354674")).append(Component.text("Server version: " + NMS.getRawVersion()).color(TextColor.fromHexString("#42484D")))).append(n)
