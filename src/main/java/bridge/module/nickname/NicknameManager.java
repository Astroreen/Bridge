...
public class NicknameManager {
    ...
    public NicknameManager(@NotNull Bridge plugin) {
        NicknameManager.plugin = plugin;
        try {
            ColorConfig = ConfigurationFile.create(new File(plugin.getDataFolder(), "color-config.yml"), plugin, "server/color-config.yml");
