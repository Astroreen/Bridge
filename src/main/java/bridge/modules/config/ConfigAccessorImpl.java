...
public class ConfigAccessorImpl implements ConfigAccessor {
    ...
    private @NotNull YamlConfiguration readFromFile() throws InvalidConfigurationException, FileNotFoundException {
        return load(configurationFile, false, configurationFile.getPath());
    }

    private @NotNull YamlConfiguration readFromResource(final Plugin plugin, final String resourceFile) throws InvalidConfigurationException, FileNotFoundException {
    ...
    private @NotNull YamlConfiguration load(final Object input, final boolean isResource, final String sourcePath) throws InvalidConfigurationException, FileNotFoundException {
        try {
    ...
    @Contract(pure = true)
    private @NotNull String buildExceptionMessage(final boolean isResource, final String sourcePath, final String message) {
