...
public class ConfigurationFileImpl extends ConfigurationSectionDecorator implements ConfigurationFile {
     ...
     */
    private ConfigurationFileImpl(final @NotNull ConfigAccessor accessor, final ConfigAccessor patchAccessor) throws InvalidConfigurationException {
    ...
    private static @Nullable ConfigAccessor createPatchAccessor(final Plugin plugin, final @NotNull String resourceFile) throws InvalidConfigurationException {
