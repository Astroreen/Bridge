...
/*     */ {
/*  29 */   public static final PacketType TYPE = PacketType.Play.Server.SPAWN_ENTITY_WEATHER;
/*     */ 
/*     */   
...
/*     */   
/*     */   public int getType() {
/*  89 */     return ((Integer)this.handle.getIntegers().read(1)).intValue();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   
/*     */   public double getX() {
/* 109 */     return ((Double)this.handle.getDoubles().read(0)).doubleValue();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 118 */     this.handle.getDoubles().write(0, Double.valueOf(value));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   
/*     */   public double getY() {
/* 129 */     return ((Double)this.handle.getDoubles().read(1)).doubleValue();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   
/*     */   public double getZ() {
/* 149 */     return ((Double)this.handle.getDoubles().read(2)).doubleValue();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 158 */     this.handle.getDoubles().write(2, Double.valueOf(value));
/*     */   }
/*     */ }


/* Location:              D:\GitHub Projects\Anicloud\Bridge\libs\PacketWrapper.jar!\com\comphenix\packetwrapper\WrapperPlayServerSpawnEntityWeather.class
